...
public class MainActivity extends AppCompatActivity {
    ...
    //funcines bluetooth para escanear
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repetirButton = findViewById(R.id.btnRepetir);
        masInfo=findViewById(R.id.btnInfo);
    ...
    public void infoObra(){
        if(descripcion!=null && descripcion!=""){
            ...
            tts.speak("Debes comenzar el trayecto.", TextToSpeech.QUEUE_ADD, null, null);
        }
    }
    public void repetirObra(){
    ...
    private class BeaconScanCallback extends ScanCallback {
        ...
        public void onScanResult(int callbackType, ScanResult result) {
            ...
            if(scanButton.getText().equals("Buscando")) {
                ...
                //Toast.makeText(MainActivity.this, "Beacon descubierto: " + result.getDevice().getAddress() + " " + result.getDevice().getName() + " " + result.getRssi(), Toast.LENGTH_SHORT).show();
                            ...
                            public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    if (document.exists()) {
                                        ...
                                        disString=document.getString("rssi");
                                        conversionRSSI=Integer.parseInt(disString);
                                        ...
                                        // Hacer lo que sea necesario con los valores obtenidos
                                    } else {
